...
STRIPE_PREMIUM_USD_PRICE_ID=<stripe-premium-usd-price-id>
STRIPE_PRO_USD_PRICE_ID=<stripe-pro-usd-price-id>
STRIPE_PREMIUM_PLN_PRICE_ID=<stripe-premium-pln-price-id>
